...
public static class DrawArrow
{
    ...
    public static void ForDebugTwoPoints(Vector3 from, Vector3 to, Color color, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f, float arrowPosition = 0.5f) {
        ForDebug(from, (to - from), color, arrowHeadLength, arrowHeadAngle, arrowPosition);
    }

    public static void ForDebugTwoPoints(Vector3 from, Vector3 to, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f, float arrowPosition = 0.5f) {
        ForDebug(from, (to - from), Color.white, arrowHeadLength, arrowHeadAngle, arrowPosition);
    }
